...
<body style="background:linear-gradient(180deg,#060d1e 0%,#030810 100%)">
    ...
    <nav class="fixed w-full bg-white dark:bg-gray-800 shadow-md z-50 transition-all duration-300" id="navbar">
        <div class="container mx-auto px-4 py-3 flex items-center justify-between">
            ...
            <div class="hidden md:flex items-center">
                <div class="space-x-4 md:space-x-6 text-gray-700 dark:text-gray-300 mr-6">
                    <a href="../index.php" class="hover:text-nc-cyan transition-colors" style="color:#94a3b8">Accueil</a>
                    <a href="../service.php" class="hover:text-nc-cyan transition-colors" style="color:#94a3b8"><?= t('nav.services') ?></a>
                    <a href="../devis.php" class="hover:text-nc-cyan transition-colors" style="color:#94a3b8"><?= t('nav.quote') ?></a>
                    <a href="../shop/shop.php" class="hover:text-nc-cyan transition-colors" style="color:#94a3b8"><?= t('nav.shop') ?></a>
                    <a href="formations.php" style="color:#00c8ff;font-weight:600"><?= t('nav.training') ?></a>
                </div>
                <?php
                ...
                <div class="flex items-center space-x-4 mr-4">
                    ...
                    <div class="relative group">
                        <button class="flex items-center hover:text-nc-cyan transition-colors" style="color:#94a3b8">
                            <i class="fas fa-user-circle text-xl mr-2"></i>
                            <span><?= t('nav.account') ?></span>
                            <i class="fas fa-chevron-down ml-1 text-xs"></i>
                        </button>
                        <div class="absolute right-0 mt-2 w-48 rounded-lg shadow-lg py-2 z-10 hidden group-hover:block" style="background:rgba(10,24,58,0.97);border:1px solid rgba(0,200,255,0.18)">
                            <a href="dashboard.php" class="block px-4 py-2 hover:text-nc-cyan transition-colors" style="color:#cbd5e1">
                                <i class="fas fa-tachometer-alt mr-2"></i><?= t('nav.dashboard') ?>
                            </a>
                            <a href="my-formations.php" class="block px-4 py-2 hover:text-nc-cyan transition-colors" style="color:#cbd5e1">
                                <i class="fas fa-graduation-cap mr-2"></i><?= t('nav.my_formations') ?>
                            </a>
                            <a href="certificates.php" class="block px-4 py-2 hover:text-nc-cyan transition-colors" style="color:#cbd5e1">
                                <i class="fas fa-certificate mr-2"></i><?= t('nav.certificates') ?>
                            </a>
                            <a href="profile.php" class="block px-4 py-2 hover:text-nc-cyan transition-colors" style="color:#cbd5e1">
                                <i class="fas fa-user-edit mr-2"></i><?= t('nav.edit_profile') ?>
                            </a>
                            <div class="my-1" style="border-top:1px solid rgba(0,200,255,0.12)"></div>
                            <a href="logout.php" class="block px-4 py-2 text-red-400 hover:text-red-300 transition-colors">
                                <i class="fas fa-sign-out-alt mr-2"></i><?= t('nav.logout') ?>
                            </a>
                        </div>
                    </div>
                    <?php else: ?>
                    <a href="login.php" class="btn-primary text-sm py-2 px-4">
                        <i class="fas fa-sign-in-alt mr-1"></i><?= t('nav.login') ?>
                    </a>
                    <?php endif; ?>
                </div>
                
                <!-- Language Switcher -->
                <a href="<?= htmlspecialchars($switchUrl) ?>" class="nc-lang-btn mr-3">
        ...
        <div id="mobile-menu" class="hidden md:hidden bg-white dark:bg-gray-800 shadow-md">
            <div class="px-4 py-2 space-y-3">
                ...
                <a href="../service.php" class="block py-2 hover:text-nc-cyan transition-colors" style="color:#94a3b8"><?= t('nav.services') ?></a>
                <a href="../devis.php" class="block py-2 hover:text-nc-cyan transition-colors" style="color:#94a3b8"><?= t('nav.quote') ?></a>
                <a href="../shop/shop.php" class="block py-2 hover:text-nc-cyan transition-colors" style="color:#94a3b8"><?= t('nav.shop') ?></a>
                <a href="formations.php" class="block py-2 font-medium" style="color:#00c8ff"><?= t('nav.training') ?></a>
                <a href="<?= htmlspecialchars($switchUrl) ?>" class="block py-2">
                    <span class="nc-lang-btn"><i class="fas fa-globe text-xs"></i><?= $switchLabel ?></span>
                </a>

                <?php if ($is_logged_in): ?>
                <div class="border-t border-gray-700 pt-2 mt-2">
                    <a href="dashboard.php" class="block py-2 hover:text-nc-cyan transition-colors" style="color:#94a3b8">
                        <i class="fas fa-tachometer-alt mr-2"></i><?= t('nav.dashboard') ?>
                    </a>
                    <a href="my-formations.php" class="block py-2 hover:text-nc-cyan transition-colors" style="color:#94a3b8">
                        <i class="fas fa-graduation-cap mr-2"></i><?= t('nav.my_formations') ?>
                    </a>
                    <a href="certificates.php" class="block py-2 hover:text-nc-cyan transition-colors" style="color:#94a3b8">
                        <i class="fas fa-certificate mr-2"></i><?= t('nav.certificates') ?>
                    </a>
                    <a href="profile.php" class="block py-2 hover:text-nc-cyan transition-colors" style="color:#94a3b8">
                        <i class="fas fa-user-edit mr-2"></i><?= t('nav.edit_profile') ?>
                    </a>
                    <a href="logout.php" class="block py-2 text-red-400">
                        <i class="fas fa-sign-out-alt mr-2"></i><?= t('nav.logout') ?>
                    </a>
                </div>
                <?php endif; ?>
        ...
        <div class="container mx-auto px-4 relative">
            <div class="text-center mb-8">
                <h1 class="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 animate__animated animate__fadeInUp text-shadow">
                    Netcrafter <span class="gradient-text"><?= t('form.title') ?></span>
                </h1>
            ...
            <div class="max-w-3xl mx-auto bg-white dark:bg-gray-800 rounded-lg shadow-lg p-4 animate__animated animate__fadeInUp animate__delay-2s">
                <form action="formations.php" method="GET" class="flex flex-col md:flex-row gap-3">
                    <div class="flex-1 relative">
                        <input type="text" name="search" value="<?php echo htmlspecialchars($search_term); ?>" placeholder="<?= t('form.search') ?>" class="w-full pl-10 pr-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 text-gray-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-netblue-500">
                        <i class="fas fa-search absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400"></i>
                    </div>
                    <button type="submit" class="btn-primary py-2 px-6">
                        <i class="fas fa-search mr-2"></i><?= t('form.search_btn') ?>
                    </button>
                    <button type="button" id="filter-toggle" class="md:hidden btn-primary py-2 px-6">
                        <i class="fas fa-filter mr-2"></i><?= t('form.filter_btn') ?>
                    </button>
                </form>
            </div>
        </div>
        ...
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
                ...
                <div class="text-center" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <h3 class="text-lg font-bold mb-2 dark:text-white"><?= t('form.pro_title') ?></h3>
                    <p class="text-sm text-gray-600 dark:text-gray-400"><?= t('form.pro_sub') ?></p>
                </div>
                ...
                <div class="text-center" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <h3 class="text-lg font-bold mb-2 dark:text-white"><?= t('form.rhythm_title') ?></h3>
                    <p class="text-sm text-gray-600 dark:text-gray-400"><?= t('form.rhythm_sub') ?></p>
                </div>
                ...
                <div class="text-center" data-aos="fade-up" data-aos-delay="300">
                    ...
                    <h3 class="text-lg font-bold mb-2 dark:text-white"><?= t('form.cert_title') ?></h3>
                    <p class="text-sm text-gray-600 dark:text-gray-400"><?= t('form.cert_sub') ?></p>
                </div>
                ...
                <div class="text-center" data-aos="fade-up" data-aos-delay="400">
                    ...
                    <h3 class="text-lg font-bold mb-2 dark:text-white"><?= t('form.community_title') ?></h3>
                    <p class="text-sm text-gray-600 dark:text-gray-400"><?= t('form.community_sub') ?></p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="flex flex-col lg:flex-row gap-8">
                ...
                <div class="lg:w-1/4 hidden lg:block">
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 sticky top-24" data-aos="fade-right">
                        <h3 class="text-xl font-bold mb-6 dark:text-white"><?= t('form.filters') ?></h3>
                        ...
                        <form action="formations.php" method="GET" id="filter-form">
                            ...
                            <!-- Categories -->
                            <div class="mb-6">
                                <h4 class="font-semibold mb-3 dark:text-white"><?= t('form.categories') ?></h4>
                                <div class="space-y-2">
                                    <div class="flex items-center">
                                        ...
                                        <label for="cat_all" class="ml-2 text-gray-700 dark:text-gray-300"><?= t('form.all_cats') ?></label>
                                    </div>
                            ...
                            <!-- Niveau -->
                            <div class="mb-6">
                                <h4 class="font-semibold mb-3 dark:text-white"><?= t('form.level') ?></h4>
                                <div class="space-y-2">
                                    <div class="flex items-center">
                                        ...
                                        <label for="level_all" class="ml-2 text-gray-700 dark:text-gray-300"><?= t('form.all_levels') ?></label>
                                    </div>
                                    <div class="flex items-center">
                                        ...
                                        <label for="level_debutant" class="ml-2 text-gray-700 dark:text-gray-300"><?= t('form.beginner') ?></label>
                                    </div>
                                    <div class="flex items-center">
                                        ...
                                        <label for="level_intermediaire" class="ml-2 text-gray-700 dark:text-gray-300"><?= t('form.intermediate') ?></label>
                                    </div>
                                    <div class="flex items-center">
                                        ...
                                        <label for="level_avance" class="ml-2 text-gray-700 dark:text-gray-300"><?= t('form.advanced') ?></label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <!-- Sort By -->
                            <div class="mb-6">
                                <h4 class="font-semibold mb-3 dark:text-white"><?= t('form.sort_by') ?></h4>
                                <select name="sort_by" class="w-full border border-gray-300 dark:border-gray-600 rounded-md px-3 py-2 bg-white dark:bg-gray-700 text-gray-800 dark:text-white">
                                    <option value="newest" <?php echo $sort_by == 'newest' ? 'selected' : ''; ?>><?= t('form.sort_newest') ?></option>
                                    <option value="price_low" <?php echo $sort_by == 'price_low' ? 'selected' : ''; ?>><?= t('form.sort_price_asc') ?></option>
                                    <option value="price_high" <?php echo $sort_by == 'price_high' ? 'selected' : ''; ?>><?= t('form.sort_price_desc') ?></option>
                                    <option value="alphabetical" <?php echo $sort_by == 'alphabetical' ? 'selected' : ''; ?>><?= t('form.sort_alpha') ?></option>
                                </select>
                            </div>

                            <!-- Apply Filters -->
                            <button type="submit" class="w-full btn-primary justify-center">
                                <?= t('form.apply_filters') ?>
                            </button>

                            <!-- Reset Filters -->
                            <a href="formations.php" class="w-full mt-3 text-center block py-2 px-4 rounded-md transition-colors" style="background:rgba(10,24,58,0.5);border:1px solid rgba(0,200,255,0.15);color:#94a3b8">
                                <?= t('form.reset_filters') ?>
                            </a>
                        </form>
                    </div>
                </div>
                ...
                <div id="mobile-filter-menu" class="fixed inset-0 bg-gray-900 bg-opacity-95 z-50 transform translate-x-full transition-transform duration-300 lg:hidden overflow-y-auto">
                    <div class="p-6">
                        <div class="flex justify-between items-center mb-6">
                            <h3 class="text-2xl font-bold text-white"><?= t('form.filters') ?></h3>
                        ...
                        <form action="formations.php" method="GET">
                            ...
                            <!-- Categories -->
                            <div class="mb-8">
                                <h4 class="text-lg font-semibold mb-4 text-white"><?= t('form.categories') ?></h4>
                                <div class="space-y-3">
                                    <div class="flex items-center">
                                        ...
                                        <label for="mobile_cat_all" class="ml-3 text-white"><?= t('form.all_cats') ?></label>
                                    </div>
                            ...
                            <!-- Niveau -->
                            <div class="mb-8">
                                <h4 class="text-lg font-semibold mb-4 text-white"><?= t('form.level') ?></h4>
                                <div class="space-y-3">
                                    <div class="flex items-center">
                                        ...
                                        <label for="mobile_level_all" class="ml-3 text-white"><?= t('form.all_levels') ?></label>
                                    </div>
                                    <div class="flex items-center">
                                        ...
                                        <label for="mobile_level_debutant" class="ml-3 text-white"><?= t('form.beginner') ?></label>
                                    </div>
                                    <div class="flex items-center">
                                        ...
                                        <label for="mobile_level_intermediaire" class="ml-3 text-white"><?= t('form.intermediate') ?></label>
                                    </div>
                                    <div class="flex items-center">
                                        ...
                                        <label for="mobile_level_avance" class="ml-3 text-white"><?= t('form.advanced') ?></label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <!-- Sort By -->
                            <div class="mb-8">
                                <h4 class="text-lg font-semibold mb-4 text-white"><?= t('form.sort_by') ?></h4>
                            ...
                            <!-- Apply Filters -->
                            <button type="submit" class="w-full btn-primary justify-center text-lg mb-4">
                                <?= t('form.apply_filters') ?>
                            </button>

                            <!-- Reset Filters -->
                            <a href="formations.php" class="w-full text-center block py-3 px-4 rounded-lg transition-colors text-lg" style="background:rgba(10,24,58,0.5);border:1px solid rgba(0,200,255,0.15);color:#94a3b8">
                                <?= t('form.reset_filters') ?>
                            </a>
                        </form>
                    </div>
                ...
                <div class="lg:w-3/4">
                        ...
                        <div>
                            <h2 class="text-xl font-bold dark:text-white">
                                <?php if (!empty($search_term)): ?>
                                    <?= t('form.results_for') ?> "<?php echo htmlspecialchars($search_term); ?>"
                                ...
                                ?>
                                    <?= t('form.cat_label') ?> <?php echo htmlspecialchars($current_category); ?>
                                <?php else: ?>
                                    <?= t('form.all_formations') ?>
                                <?php endif; ?>
                            </h2>
                            <p class="text-gray-600 dark:text-gray-400 mt-1">
                                <?php echo $total_formations; ?> <?= t('form.found') ?>
                            </p>
                        </div>
                        ...
                        <div class="mt-4 sm:mt-0 self-stretch sm:self-auto w-full sm:w-auto lg:hidden">
                            <form action="formations.php" method="GET" class="flex">
                                ...
                                <select name="sort_by" onchange="this.form.submit()" class="w-full border border-gray-300 dark:border-gray-600 rounded-md px-3 py-2 bg-white dark:bg-gray-700 text-gray-800 dark:text-white">
                                    <option value="newest" <?php echo $sort_by == 'newest' ? 'selected' : ''; ?>><?= t('form.sort_by') ?> : <?= t('form.sort_newest') ?></option>
                                    <option value="price_low" <?php echo $sort_by == 'price_low' ? 'selected' : ''; ?>><?= t('form.sort_by') ?> : <?= t('form.sort_price_asc') ?></option>
                                    <option value="price_high" <?php echo $sort_by == 'price_high' ? 'selected' : ''; ?>><?= t('form.sort_by') ?> : <?= t('form.sort_price_desc') ?></option>
                                    <option value="alphabetical" <?php echo $sort_by == 'alphabetical' ? 'selected' : ''; ?>><?= t('form.sort_by') ?> : <?= t('form.sort_alpha') ?></option>
                                </select>
                            </form>
                        </div>
                    </div>
                            ...
                            <div class="relative h-48">
                                ...
                                <div class="absolute bottom-3 left-3 text-white text-xs font-bold px-2 py-1 rounded
                                    ...
                                    switch($formation['level']) {
                                        case 'debutant':     echo 'bg-green-600'; break;
                                        case 'intermediaire':echo 'bg-yellow-600'; break;
                                        case 'avance':       echo 'bg-red-600'; break;
                                    }
                                    ?>">
                                    <?php
                                    switch($formation['level']) {
                                        case 'debutant':     echo t('form.beginner'); break;
                                        case 'intermediaire':echo t('form.intermediate'); break;
                                        case 'avance':       echo t('form.advanced'); break;
                                    }
                                    ?>
                                </div>
                            </div>
                            ...
                            <div class="p-4">
                                ...
                                <div class="flex items-center mb-3 text-sm text-gray-500 dark:text-gray-400">
                                    <div class="flex items-center mr-4">
                                        ...
                                        <span><?php echo !empty($formation['duration']) ? htmlspecialchars($formation['duration']) : t('form.var_duration'); ?></span>
                                    </div>
                                    <div class="flex items-center">
                                ...
                                <div class="flex justify-between items-center">
                                    <div class="text-netblue-600 dark:text-netblue-400 font-bold">
                                        <?php echo number_format($formation['price_per_month'], 0, ',', ' '); ?> FCFA<span class="text-sm font-normal"><?= $_d('/mois','/month') ?></span>
                                    </div>
                                    <a href="formation-details.php?id=<?php echo $formation['id']; ?>" class="btn-primary text-sm py-2 px-4">
                                        <?= t('form.discover') ?>
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="flex flex-col items-center justify-center py-12 bg-white dark:bg-gray-800 rounded-lg shadow-md" data-aos="fade-up">
                        ...
                        <h3 class="text-2xl font-bold mb-2 dark:text-white"><?= t('form.not_found_title') ?></h3>
                        <p class="text-gray-600 dark:text-gray-400 text-center max-w-md">
                            <?= t('form.not_found_sub') ?>
                        </p>
                        <a href="formations.php" class="mt-6 btn-primary">
                            <?= t('form.see_all') ?>
                        </a>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="mt-12 bg-gradient-to-r from-netblue-600 to-netblue-800 rounded-lg shadow-lg overflow-hidden" data-aos="fade-up">
                        <div class="flex flex-col md:flex-row">
                            <div class="md:w-2/3 p-6 md:p-8 text-white">
                                <h3 class="text-xl md:text-2xl font-bold mb-3"><?= t('form.cta_title') ?></h3>
                                <p class="mb-6">
                                    <?= t('form.cta_sub') ?>
                                </p>
                                <a href="../devis.php" class="inline-block bg-white font-bold py-2 px-6 rounded-lg transition-colors" style="color:#0066cc">
                                    <?= t('form.contact_us') ?>
                                </a>
                            </div>
    ...
    <section class="py-8 bg-white dark:bg-gray-800">
        <div class="container mx-auto px-4">
            <h2 class="text-2xl font-bold mb-6 dark:text-white"><?= t('form.popular') ?></h2>
                    ...
                    <div class="p-3">
                        ...
                        <div class="flex justify-between items-center mt-2">
                            ...
                            <span class="text-xs px-2 py-1 rounded
                                <?php
                                switch($formation['level']) {
                                    case 'debutant':     echo 'bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-300'; break;
                                    case 'intermediaire':echo 'bg-yellow-100 text-yellow-800 dark:bg-yellow-900 dark:text-yellow-300'; break;
                                    case 'avance':       echo 'bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-300'; break;
                                }
                                ?>">
                                <?php
                                switch($formation['level']) {
    ...
    <section class="py-12 bg-gray-100 dark:bg-gray-900">
        <div class="container mx-auto px-4">
            <h2 class="text-2xl font-bold mb-8 text-center dark:text-white"><?= t('form.testimonials') ?></h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <p class="text-gray-600 dark:text-gray-300 mb-6 italic">
                        "<?= $_d('La formation en réseau informatique m\'a permis d\'acquérir des compétences très recherchées sur le marché. Les vidéos sont claires et le forum m\'a aidé à résoudre mes problèmes. Je recommande vivement !','The networking course helped me acquire highly sought-after skills. The videos are clear and the forum helped me solve my issues. Highly recommended!') ?>"
                    </p>
                    <div class="flex items-center">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <p class="text-gray-600 dark:text-gray-300 mb-6 italic">
                        "<?= $_d('J\'ai pu créer ma boutique en ligne grâce à la formation e-commerce. Tout est expliqué pas à pas et le certificat m\'a aidé à gagner la confiance de mes clients. Excellente plateforme d\'apprentissage !','I was able to launch my online store thanks to the e-commerce course. Everything is explained step by step and the certificate helped me gain my customers\' trust. Excellent learning platform!') ?>"
                    </p>
                    <div class="flex items-center">
                        <div class="bg-gray-300 dark:bg-gray-600 w-10 h-10 rounded-full flex items-center justify-center text-gray-600 dark:text-gray-300 mr-3">
                            <i class="fas fa-user"></i>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6" data-aos="fade-up" data-aos-delay="300">
                    ...
                    <p class="text-gray-600 dark:text-gray-300 mb-6 italic">
                        "<?= $_d('La formation Excel avancé m\'a fait gagner en productivité dans mon travail quotidien. Les tutoriels sont bien structurés et le formateur est très pédagogue. Le prix est très abordable pour la qualité proposée.','The advanced Excel course boosted my daily productivity. The tutorials are well structured and the instructor is very clear. The price is very affordable for the quality offered.') ?>"
                    </p>
                    <div class="flex items-center">
                        <div class="bg-gray-300 dark:bg-gray-600 w-10 h-10 rounded-full flex items-center justify-center text-gray-600 dark:text-gray-300 mr-3">
                            <i class="fas fa-user"></i>
    ...
    <section class="py-12 bg-white dark:bg-gray-800">
        <div class="container mx-auto px-4">
            <h2 class="text-2xl font-bold mb-8 text-center dark:text-white"><?= $_d('Pourquoi choisir notre plateforme de formation','Why choose our training platform') ?></h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div class="text-center" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <h3 class="text-xl font-bold mb-3 dark:text-white"><?= $_d('Formateurs experts','Expert instructors') ?></h3>
                    <p class="text-gray-600 dark:text-gray-300">
                        <?= $_d('Nos formateurs sont des professionnels reconnus dans leur domaine avec une solide expérience terrain.','Our instructors are recognized professionals in their field with solid real-world experience.') ?>
                    </p>
                </div>
                ...
                <div class="text-center" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <h3 class="text-xl font-bold mb-3 dark:text-white"><?= $_d('Accessible partout','Access anywhere') ?></h3>
                    <p class="text-gray-600 dark:text-gray-300">
                        <?= $_d('Accédez à vos formations depuis n\'importe quel appareil : ordinateur, tablette ou smartphone.','Access your courses from any device: computer, tablet, or smartphone.') ?>
                    </p>
                </div>
                ...
                <div class="text-center" data-aos="fade-up" data-aos-delay="300">
                    ...
                    <h3 class="text-xl font-bold mb-3 dark:text-white"><?= $_d('Contenu à jour','Up-to-date content') ?></h3>
                    <p class="text-gray-600 dark:text-gray-300">
                        <?= $_d('Nos formations sont régulièrement mises à jour pour refléter les dernières avancées technologiques.','Our courses are regularly updated to reflect the latest technological advances.') ?>
                    </p>
                </div>
                ...
                <div class="text-center" data-aos="fade-up" data-aos-delay="400">
                    ...
                    <h3 class="text-xl font-bold mb-3 dark:text-white"><?= $_d('Support dédié','Dedicated support') ?></h3>
                    <p class="text-gray-600 dark:text-gray-300">
                        <?= $_d('Notre équipe de support est disponible pour vous aider à chaque étape de votre apprentissage.','Our support team is available to help you at every step of your learning journey.') ?>
                    </p>
                </div>
            </div>
        </div>
    ...
    <section class="py-12 bg-netblue-600 dark:bg-netblue-800 text-white">
        <div class="container mx-auto px-4 text-center">
            <h2 class="text-3xl font-bold mb-4"><?= $_d('Prêt à développer vos compétences ?','Ready to develop your skills?') ?></h2>
            <p class="text-xl mb-8 max-w-3xl mx-auto">
                <?= $_d('Rejoignez notre communauté d\'apprenants et accédez à des formations de qualité pour booster votre carrière et rester compétitif sur le marché du travail.','Join our learning community and access quality courses to boost your career and stay competitive in the job market.') ?>
            </p>
            <div class="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-4">
                ...
                <a href="register.php" class="bg-white text-netblue-600 hover:bg-netblue-100 font-bold py-3 px-8 rounded-lg transition-colors inline-block">
                    <i class="fas fa-user-plus mr-2"></i><?= $_d('Créer un compte','Create an account') ?>
                </a>
                <a href="login.php" class="bg-transparent border-2 border-white hover:bg-white hover:text-netblue-600 text-white font-bold py-3 px-8 rounded-lg transition-colors inline-block">
                    <i class="fas fa-sign-in-alt mr-2"></i><?= $_d('Se connecter','Sign in') ?>
                </a>
                <?php else: ?>
                <a href="formations.php" class="bg-white text-netblue-600 hover:bg-netblue-100 font-bold py-3 px-8 rounded-lg transition-colors inline-block">
                    <i class="fas fa-graduation-cap mr-2"></i><?= $_d('Explorer toutes les formations','Browse all courses') ?>
                </a>
                <?php endif; ?>
            </div>
        </div>
    ...
    <section class="py-12 bg-gray-50 dark:bg-gray-900">
        <div class="container mx-auto px-4">
            <h2 class="text-2xl font-bold mb-8 text-center dark:text-white"><?= $_d('Questions fréquentes','Frequently asked questions') ?></h2>
            ...
            <div class="max-w-3xl mx-auto space-y-4" data-aos="fade-up">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
                    <button class="faq-toggle w-full flex justify-between items-center p-4 text-left">
                        <span class="font-bold text-gray-800 dark:text-white"><?= $_d('Comment fonctionne l\'abonnement ?','How does the subscription work?') ?></span>
                    ...
                    <div class="faq-content hidden p-4 pt-0 text-gray-600 dark:text-gray-300 border-t border-gray-200 dark:border-gray-700">
                        <p>
                            <?= $_d('L\'abonnement est mensuel et vous donne un accès complet à la formation choisie. Vous pouvez vous abonner pour un ou plusieurs mois. Après votre inscription, vous effectuez un paiement via l\'un de nos partenaires (Nita, Amana, Zeyna, Niya), et envoyez le reçu. Après validation par notre équipe (généralement sous 24h), vous aurez accès à l\'intégralité du contenu de la formation.','The subscription is monthly and gives you full access to the chosen course. You can subscribe for one or more months. After registering, you make a payment through one of our partners (Nita, Amana, Zeyna, Niya) and send the receipt. After validation by our team (usually within 24h), you will have access to the full course content.') ?>
                        </p>
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
                    <button class="faq-toggle w-full flex justify-between items-center p-4 text-left">
                        <span class="font-bold text-gray-800 dark:text-white"><?= $_d('Comment obtenir mon certificat ?','How do I get my certificate?') ?></span>
                        <i class="fas fa-chevron-down text-netblue-600 dark:text-netblue-400 transition-transform"></i>
                    </button>
                    <div class="faq-content hidden p-4 pt-0 text-gray-600 dark:text-gray-300 border-t border-gray-200 dark:border-gray-700">
                        <p>
                            <?= $_d('À la fin de chaque formation, vous aurez accès à un quiz final qui évaluera vos connaissances. Une fois que vous aurez réussi ce quiz (score minimum de 70%), vous pourrez générer votre certificat en remplissant vos informations personnelles. Le certificat sera disponible en format PDF, que vous pourrez télécharger ou imprimer.','At the end of each course, you will have access to a final quiz that tests your knowledge. Once you pass (minimum score of 70%), you can generate your certificate by entering your personal information. The certificate will be available as a PDF that you can download or print.') ?>
                        </p>
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
                    <button class="faq-toggle w-full flex justify-between items-center p-4 text-left">
                        <span class="font-bold text-gray-800 dark:text-white"><?= $_d('Puis-je suivre les formations sur mon téléphone ?','Can I take courses on my phone?') ?></span>
                        <i class="fas fa-chevron-down text-netblue-600 dark:text-netblue-400 transition-transform"></i>
                    </button>
                    <div class="faq-content hidden p-4 pt-0 text-gray-600 dark:text-gray-300 border-t border-gray-200 dark:border-gray-700">
                        <p>
                            <?= $_d('Oui, notre plateforme est entièrement responsive et optimisée pour les appareils mobiles. Vous pouvez suivre vos formations depuis un ordinateur, une tablette ou un smartphone. La progression est synchronisée entre tous vos appareils, ce qui vous permet de commencer sur un appareil et de continuer sur un autre.','Yes, our platform is fully responsive and optimized for mobile devices. You can take courses on a computer, tablet, or smartphone. Progress is synced across all your devices, so you can start on one and continue on another.') ?>
                        </p>
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
                    <button class="faq-toggle w-full flex justify-between items-center p-4 text-left">
                        <span class="font-bold text-gray-800 dark:text-white"><?= $_d('Comment puis-je poser des questions si je suis bloqué ?','How can I ask questions if I get stuck?') ?></span>
                        <i class="fas fa-chevron-down text-netblue-600 dark:text-netblue-400 transition-transform"></i>
                    </button>
                    <div class="faq-content hidden p-4 pt-0 text-gray-600 dark:text-gray-300 border-t border-gray-200 dark:border-gray-700">
                        <p>
                            <?= $_d('Chaque formation dispose d\'un forum dédié où vous pouvez poser vos questions. Les formateurs et les autres apprenants peuvent vous répondre. Vous pouvez également contacter notre support technique via le formulaire de contact si vous rencontrez des problèmes techniques avec la plateforme.','Each course has a dedicated forum where you can ask questions. Instructors and fellow learners can reply. You can also contact our technical support via the contact form if you encounter technical issues with the platform.') ?>
                        </p>
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
                    <button class="faq-toggle w-full flex justify-between items-center p-4 text-left">
                        <span class="font-bold text-gray-800 dark:text-white"><?= $_d('Les formations sont-elles reconnues officiellement ?','Are the courses officially recognized?') ?></span>
                        <i class="fas fa-chevron-down text-netblue-600 dark:text-netblue-400 transition-transform"></i>
                    </button>
                    <div class="faq-content hidden p-4 pt-0 text-gray-600 dark:text-gray-300 border-t border-gray-200 dark:border-gray-700">
                        <p>
                            <?= $_d('Nos formations sont conçues par des professionnels du secteur et visent à vous donner des compétences pratiques. Les certificats que nous délivrons attestent de votre suivi de la formation et de la validation de vos connaissances. Bien qu\'ils ne soient pas des diplômes d\'État, ils sont reconnus par de nombreuses entreprises comme preuve de vos compétences dans le domaine concerné.','Our courses are designed by industry professionals and aim to give you practical skills. The certificates we issue confirm course completion and knowledge validation. While they are not state-issued diplomas, they are recognized by many companies as proof of your expertise in the relevant field.') ?>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <p class="text-gray-400 mb-6">
                        <?= $_d('Solutions informatiques globales pour les entreprises : développement, équipement et formation professionnelle.','Global IT solutions for businesses: development, equipment and professional training.') ?>
                    </p>
                    <p class="text-gray-400">
                        © 2025 Netcrafter. <?= $_d('Tous droits réservés.','All rights reserved.') ?>
                    </p>
                </div>
                
                <!-- Quick Links -->
                <div>
                    <h4 class="text-xl font-bold mb-6"><?= $_d('Liens rapides','Quick links') ?></h4>
                    <ul class="space-y-3">
                ...
                <!-- Formations -->
                <div>
                    <h4 class="text-xl font-bold mb-6"><?= $_d('Nos formations','Our courses') ?></h4>
                    <ul class="space-y-3">
                        ...
                        <li><a href="formations.php" class="text-netblue-400 hover:text-netblue-300 transition-colors">
                            <i class="fas fa-graduation-cap mr-2"></i><?= $_d('Toutes les formations','All courses') ?>
                        </a></li>
                    </ul>
                </div>
                ...
                <!-- Contact -->
                <div>
                    <h4 class="text-xl font-bold mb-6"><?= $_d('Contactez-nous','Contact us') ?></h4>
    ...
    <div id="fav-toast" class="fixed bottom-4 right-4 bg-purple-600 text-white px-6 py-3 rounded-lg shadow-lg transform translate-y-24 opacity-0 transition-all duration-300 flex items-center z-50">
        ...
        <span><?= $_d('Formation ajoutée aux favoris','Course added to favourites') ?></span>
    </div>
    ...
    <div id="fav-removed-toast" class="fixed bottom-4 right-4 bg-gray-700 text-white px-6 py-3 rounded-lg shadow-lg transform translate-y-24 opacity-0 transition-all duration-300 flex items-center z-50">
        ...
        <span><?= $_d('Formation retirée des favoris','Course removed from favourites') ?></span>
    </div>
